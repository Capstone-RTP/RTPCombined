...
int main(void)
{
  ...
  /* USER CODE BEGIN WHILE */
	...
	while (1)
	{
		...
		//		if(scanState == posReceive && uartRecievedFlag && yMotor.Status == Stopped && thetaMotor.Status == Stopped){
		...
		//			if((nextInstr.th - thetaMotor.TargetPosition)>=0){
		//				setTarget(&thetaMotor, nextInstr.th - thetaMotor.TargetPosition, 1);
		//			}
		//			else{
		//				setTarget(&thetaMotor, nextInstr.th - thetaMotor.TargetPosition, 0);
		//			}
		//			//Increment Y based on direction
		//			if((nextInstr.y - yMotor.TargetPosition)>=0){
		//				setTarget(&yMotor, nextInstr.th - yMotor.TargetPosition, 1);
		//			}
		//			else{
		//				setTarget(&yMotor, nextInstr.th - yMotor.TargetPosition, 0);
		//			}
		//			scanState = distGet;
		//		}
		//		else if(scanState == goToPos && yMotor.Status == Stopped && thetaMotor.Status == Stopped){
